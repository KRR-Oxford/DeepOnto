...
- [3] *Jiaoyan Chen, Yuan He, Yuxia Geng, Ernesto Jiménez-Ruiz, Hang Dong and Ian Horrocks.* **Contextual Semantic Embeddings for Ontology Subsumption Prediction**. World Wide Web. /[arxiv](https://arxiv.org/abs/2202.09791)/  (We are working on transforming its original [experiment codes](https://gitlab.com/chen00217/bert_subsumption) to this project) <a name="bertsubs_paper"></a>
