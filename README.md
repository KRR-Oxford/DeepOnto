...
- [4] *Yuan He‚ Jiaoyan Chen, Ernesto Jiménez-Ruiz, Hang Dong and Ian Horrocks.* **Language Model Analysis for Ontology Subsumption Inference**. Findings of the Association for Computational Linguistics (ACL-2023). /[arxiv](https://arxiv.org/abs/2302.06761)/  <a name="ontolama_paper"></a>
- [5] *Yuan He‚ Jiaoyan Chen, Hang Dong，Ian Horrocks， Carlo Allocca, Taehun Kim and Brahmananda Sapkota.* **DeepOnto: A Python Package for Ontology Engineering with Deep Learning**. Submitted to Semantic Web Journal. /[arxiv](https://arxiv.org/abs/2307.03067)/  <a name="system_paper"></a>
